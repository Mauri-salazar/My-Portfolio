...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(resul.code === 200) {
      ...
      setStatus({success: false , message: 'Something went wrong, please try agaim later'});
    }
  };
                  ...
                  <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <Col size={12} className="px-1">
                        <textarea rows="6" value={formDetails.message} placeholder="Motivo de Contacto" onChange={(e) => onFormUpdate('message', e.target.value)}></textarea>
